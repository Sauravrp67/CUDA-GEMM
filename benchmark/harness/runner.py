...
from benchmark.harness.baselines import make_case_callable, resolve_kernel_name
...
from benchmark.utils.timer import bench_gpu_time
...
def run_case(
    ...
    terminal_x_value = int(x_values[-1])
    ...
    for kernel_name in kernels:
        ...
        for x_value in x_values:
            ...
            record["terminal_sweep_value"] = terminal_x_value
            record["is_terminal_sweep_value"] = int(x_value) == terminal_x_value
